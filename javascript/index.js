...
const handleClick  = async (data , i) => {
    ...
    const secondaryPainel = document.querySelector('.secondary-painel');

    // if (existingPainel) existingPainel.remove();

    if (existingPainel) {
        existingPainel.remove()
        secondaryPainel.style.display = 'block';
    }
...
iconClose.addEventListener('click' , () => {
    ...
    secondaryPainel.style.display = 'none'

})

// Função para obter e exibir o width da tela
